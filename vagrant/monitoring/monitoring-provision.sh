...
# 라벨/테인트(선택)
NODE_LABELS="${NODE_LABELS:-role=monitoring,tier=app}"
NODE_TAINTS="${NODE_TAINTS:-}"            # 예: "dedicated=monitoring:NoSchedule"
